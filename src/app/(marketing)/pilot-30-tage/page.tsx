...
const ACCENT = "#4338CA"; // Indigo — eigenständig von Sales/Recruiting/KMU/Wissen/ARIA, steht für Strategie/Innovation

export const metadata: Metadata = {
  title: "KI-Pilot in 30 Tagen: Vom Anwendungsfall zum Business Case",
  description:
    "In 30 Tagen von der KI-Idee zum funktionierenden Piloten: Prozessanalyse, Prototyp, Praxistest und Business Case — für Unternehmen, die einen konkreten KI-Anwendungsfall umsetzen wollen.",
  alternates: {
    canonical: "https://app.neuronic-automation.ai/pilot-30-tage",
  },
  openGraph: {
    type: "website",
    locale: "de_DE",
    url: "https://app.neuronic-automation.ai/pilot-30-tage",
    title: "KI-Pilot in 30 Tagen: Vom Anwendungsfall zum Business Case",
    description:
      "In 30 Tagen von der KI-Idee zum funktionierenden Piloten: Prozessanalyse, Prototyp, Praxistest und Business Case — für Unternehmen, die einen konkreten KI-Anwendungsfall umsetzen wollen.",
  },
...
export default function PilotPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/30">
      <PageViewBeacon slug="pilot-30-tage" />
