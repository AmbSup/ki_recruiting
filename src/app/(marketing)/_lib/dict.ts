...
export const dict: Record<Lang, Dict> = {
  de: {
    ...
    pricing: {
      eyebrow: "Preise",
      headline: "Ein Setup-Preis. Ein Monatsabo. Ohne Bullshit.",
      sub:
        "Setup-Fee für Prompt-Design, Voice + Integration in deine Systeme. Danach ein festes Monatsabo mit inkludierten KI-Anrufen. Keine versteckten Per-Minute-Kosten, keine Nachverhandlung nach Monat 3.",
      billing_note: "Alle Preise netto, zzgl. USt. Abrechnung monatlich per Rechnung oder SEPA-Lastschrift.",
      overage_label: "Extra-Anrufe über Kontingent",
      overage_value: "€0.35 / Min",
      setup_label: "Setup",
      setup_note: "einmalig",
      ...
      tiers: [
        {
          ...
          highlight: false,
          bullets: [
            "500 KI-Anrufe pro Monat inkludiert",
        ...
        },
        {
          ...
          bullets: [
            ...
            "Custom-Voice (Cartesia + Azure Whisper)",
          ],
        },
        {
          key: "agency",
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: "Was passiert wenn ich über das Anruf-Kontingent komme?",
            a: "€0.35 pro zusätzliche Minute — transparent im Dashboard sichtbar, keine Überraschungs-Rechnung. Wenn du dauerhaft über dem Kontingent bist, machen wir einen Tier-Upgrade-Vorschlag der günstiger für dich ist.",
          },
          {
            q: "Gibt es eine Mindestlaufzeit?",
            a: "Monatlich kündbar. Optional: 12-Monats-Commitment gegen 15% Rabatt auf das Monatsabo. Der Setup-Preis ist einmalig und nicht rückerstattbar sobald wir dein Setup gebaut haben.",
          },
          {
          ...
          },
          {
            ...
            a: "Ja. Ein Pro-Tier deckt beide Verticals ab (2 Funnels = 1 Sales + 1 Recruiting, 3. Funnel frei wählbar). Agency-Tier hat unlimited Funnels, du kannst also beliebig mischen.",
          },
          {
      ...
      pilot: {
        ...
        sub:
          "Aktuell suchen wir 3-5 Pilot-Partner die bereit sind, uns nach 30 Tagen eine kurze Case-Study zu geben (Zahlen + LinkedIn-Post). Als Gegenleistung: Setup-Preis halbiert. €750 statt €1.500 im Starter-Tier, €1.250 statt €2.500 im Pro-Tier. Monatsabo bleibt regulär.",
  ...
  en: {
    ...
    pricing: {
      eyebrow: "Pricing",
      headline: "One setup price. One monthly plan. No BS.",
      sub:
        "Setup covers prompt design, voice selection, and integration with your systems. After that, a flat monthly plan with included AI calls. No hidden per-minute charges, no renegotiation after month three.",
      billing_note: "All prices exclude VAT. Billed monthly by invoice or SEPA direct debit.",
      overage_label: "Extra calls beyond quota",
      overage_value: "€0.35 / min",
      setup_label: "Setup",
      setup_note: "one-time",
      ...
      tiers: [
        {
          ...
          highlight: false,
          bullets: [
            "500 AI calls per month included",
      ...
      faq: {
        ...
        items: [
          ...
          {
            q: "What happens if I exceed the call quota?",
            a: "€0.35 per extra minute — transparent in the dashboard, no surprise bill. If you consistently exceed the quota we suggest a tier upgrade that's cheaper for you.",
          },
          {
            q: "Any minimum commitment?",
            a: "Month-to-month. Optional: 12-month commitment for a 15% discount on the monthly fee. The setup fee is one-time and non-refundable once we've built your system.",
          },
          {
          ...
          },
          {
            ...
            a: "Yes. A Pro tier covers both verticals (2 funnels = 1 sales + 1 recruiting, the third funnel is your choice). Agency tier has unlimited funnels — mix as you like.",
          },
          {
      ...
      pilot: {
        ...
        sub:
          "We're currently looking for 3-5 pilot partners who'll give us a short case study after 30 days (numbers + LinkedIn post). In return: setup fee cut in half. €750 instead of €1,500 on Starter, €1,250 instead of €2,500 on Pro. Monthly plan stays at list price.",
