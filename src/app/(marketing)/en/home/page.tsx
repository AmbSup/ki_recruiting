...
// /en/home — see ../../home/page.tsx for why this exists (auth-redirect-free
// alias of /en). Canonical points at /en.
...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://app.neuronic-automation.ai/en/home",
    title: "AI Funnel Expert — The AI Call in 30 Seconds",
    description:
      "AI funnels for Sales and Recruiting. Your lead or candidate gets called back within 30 seconds. Fully automated. 24/7.",
  },
...
export default function EnHomeAliasPage() {
