...
BEGIN
  ...
  IF v_existing_program IS NULL THEN
    INSERT INTO sales_programs (
      ...
      'de',
      'generic',
      'Neuronic Automate hilft Unternehmen dabei, Arbeitsabläufe mit KI zu automatisieren und individuelle KI-Lösungen zu entwickeln — bewährte Bausteine (Anfragen-Annahme, Angebote aus Sprachmemos, Bewerber-Screening, Rechnungsstellung, Mahnwesen) plus individuelle Lösungen mit den neuesten KI-Tools.',
