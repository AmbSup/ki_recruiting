...
BEGIN
  ...
  v_first_msg := 'Hallo {{first_name}}, hier ist Andrea von Neuronic Automation. Wir helfen Unternehmen dabei, Arbeitsabläufe mit KI zu automatisieren und individuelle KI-Apps zu entwickeln. Ich bräuchte kurz eine Minute Ihrer Zeit — wir nutzen für diesen kurzen drei-Minuten-Anruf einen KI-Assistenten und dieses Gespräch wird aufgezeichnet. Ist das in Ordnung für Sie? Dann sagen Sie bitte JA.';
