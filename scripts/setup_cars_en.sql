...
BEGIN
  ...
  INSERT INTO sales_offers (
    ...
    (v_program_id,
     ...
     'The VW Tiguan 2024 is a versatile 7-seat family SUV built for long family trips and daily duty. **Performance:** 2.0 TDI 4-cylinder diesel with 150 hp and 360 Nm, 7-speed DSG dual-clutch, optional 4Motion all-wheel drive. 0-100 km/h in 9.6 seconds, top speed 207 km/h. **Range & Efficiency:** combined consumption 6.2 L/100km, roughly 900 km of tank range. **Cargo:** 700 L with the third row folded, up to 1,920 L with row 2+3 folded — class-leading for the segment. **Tech & Equipment:** 10-inch digital cockpit, 12-inch Discover Pro infotainment with wireless Apple CarPlay and Android Auto, panoramic sunroof, IQ.Light matrix LED headlights, 3-zone climate control, heated front seats, Travel Assist (adaptive cruise + lane-keep + traffic-jam assist), front + rear parking sensors with rear camera. **Safety:** 5-star Euro NCAP (2022), 9 airbags, Front Assist with autonomous emergency braking. **Warranty & Service:** 4-year manufacturer warranty + 8-year mobility guarantee, service intervals every 30,000 km or 2 years. **Availability:** dealer pickup at any Volkswagen partner nationwide, 4-6 week delivery from stock, 8 exterior colors available. **Sample lease:** from 299 EUR/month over 36 months with 10,000 km/year and 5,000 EUR down payment, all-inclusive service package available as add-on for around 35 EUR/month.',
    ...
    (v_program_id,
     ...
     'The BMW M3 Competition is a track-tuned high-performance sports sedan, hand-assembled in Garching with motorsport-derived hardware. **Performance:** S58 3.0-litre twin-turbo inline-six, 510 hp and 650 Nm, 8-speed M Steptronic. 0-100 km/h in 3.5 seconds, top speed 290 km/h with the optional M Driver''s Package. **Range & Efficiency:** combined consumption 9.6 L/100km, around 600 km tank range. **Cargo:** 480 L boot. **Tech & Equipment:** carbon-fibre roof + interior trim, adaptive M suspension with electronically controlled dampers, M Drive Professional package (Drift Analyser, M Laptimer, 10-stage traction control), 12.3-inch BMW Live Cockpit Professional with M-specific layouts, harman/kardon premium sound, M Sport bucket seats in Merino leather, head-up display, gesture control. **Safety:** 4-star Euro NCAP, Driving Assistant Professional available (adaptive cruise, lane-keep, traffic-jam assist), 8 airbags. **Warranty & Service:** 3-year unlimited-mileage manufacturer warranty, 12-year anti-perforation, BMW Service Inclusive packages available up to 10 years / 200,000 km. Condition-based service — no fixed intervals. **Availability:** 6-8 week delivery build-to-order, 6 standard colors including Frozen Brilliant White Metallic, individual program available for bespoke paint. **Sample lease:** from 1,099 EUR/month over 36 months with 15,000 km/year and 20,000 EUR down payment, M Track Days included for new owners.',
    ...
    (v_program_id,
     ...
     'The Tesla Model Y Long Range is Tesla''s mid-size electric family SUV — the best-selling EV in Europe and a benchmark for range, software and supercharger network. **Battery & Range:** 75 kWh usable battery, around 530 km of WLTP range, peak DC charging at 250 kW gets you from 15 to 80 percent in roughly 27 minutes at any Tesla Supercharger. **Performance:** dual-motor all-wheel drive, 0-100 km/h in 5.0 seconds, top speed 217 km/h. **Cargo:** 854 L total including the front trunk, 2,158 L with the rear seats folded — flat loading floor, optional third row for 7-seat family configuration. **Tech & Equipment:** 15-inch landscape touchscreen runs the entire interior, Autopilot included as standard with adaptive cruise and auto-lane-change, optional Full Self-Driving as 99 EUR/month subscription, full-glass panoramic roof, 14-speaker premium audio, heated front and rear seats, HEPA cabin filter with Bioweapon Defence Mode, Sentry Mode and Dog Mode. Over-the-air updates monthly. **Safety:** 5-star Euro NCAP, 8 airbags, structural battery pack contributes to rigidity. **Warranty & Service:** 4-year vehicle warranty, 8-year or 192,000 km battery warranty with 70 percent capacity guarantee, no scheduled servicing — only brake fluid every 2 years and cabin filter. **Availability:** 2-4 week delivery from inventory, 5 exterior colors (Pearl White free, others up to 2,500 EUR), pickup at any Tesla service centre across Europe. **Sample lease:** from 499 EUR/month over 36 months with 10,000 km/year and 10,000 EUR down payment, supercharger credit and home-charger discount available for new orders.',
    ...
    (v_program_id,
     ...
     'The VW ID.4 Pro is Volkswagen''s flagship all-electric SUV — the European Car of the Year 2021 with a focus on space, refinement and a real-world usable range. **Battery & Range:** 77 kWh usable battery, around 530 km of WLTP range, peak DC charging at 135 kW (10 to 80 percent in roughly 30 minutes at any CCS fast-charger), 11 kW onboard AC charger. **Performance:** rear-wheel-drive electric motor with 204 hp and 310 Nm, 0-100 km/h in 8.5 seconds, top speed electronically limited to 160 km/h. **Cargo:** 543 L boot with a flat load floor, 1,575 L with the rear seats folded, 500 kg tow rating with trailer hitch. **Tech & Equipment:** 12-inch Discover Pro infotainment, ID.Light interactive light strip across the dashboard, ID. travel assist with adaptive cruise + lane-keep + automatic lane changes on motorways, IQ.Light matrix LED headlights, augmented-reality head-up display optional, wireless Apple CarPlay and Android Auto, optional heat pump for winter range retention, panoramic glass roof. **Safety:** 5-star Euro NCAP (2021), 7 airbags, Front Assist with autonomous emergency braking, pedestrian + cyclist detection. **Warranty & Service:** 2-year vehicle warranty, 8-year or 160,000 km battery warranty with 70 percent capacity guarantee, no oil changes — service intervals every 30,000 km or 2 years just for brake fluid and cabin filters. **Availability:** 4-6 week delivery from stock, 7 exterior colors, dealer-network nationwide with Volkswagen Charging service for We Charge customers. **Sample lease:** from 399 EUR/month over 36 months with 10,000 km/year and 7,500 EUR down payment, home wallbox installation available as add-on for around 1,200 EUR.',
    ...
    (v_program_id,
     ...
     'The Porsche Taycan 4S delivers an electric sports-sedan experience with proper Porsche DNA — race-car responsiveness, 800-volt architecture borrowed from the 919 hybrid Le Mans car, and the lowest centre of gravity of any production Porsche. **Battery & Range:** 93 kWh Performance Battery Plus, around 440 km of WLTP range, peak DC charging at 270 kW (5 to 80 percent in 22 minutes at any 800V or 400V Ionity charger), 11 kW or optional 22 kW onboard AC charger. **Performance:** dual permanent-magnet synchronous motors with all-wheel drive, 530 hp combined with launch control and overboost, 650 Nm of torque. 0-100 km/h in 4.0 seconds, top speed 250 km/h. **Cargo:** 366 L rear boot + 84 L frunk for 450 L total. **Tech & Equipment:** Porsche InnoDrive predictive adaptive cruise that reads the road ahead, adaptive air suspension with PASM, Sport Chrono package with Track Precision app, four-zone climate, 14-speaker BOSE Surround Sound, matrix LED headlights with Porsche Dynamic Light System Plus, 16.8-inch curved digital cockpit + 10.9-inch central infotainment + optional 10.9-inch passenger display, full-glass panoramic roof optional. **Safety:** equivalent of 5-star Euro NCAP (not officially rated), 8 airbags, lane-change assist, surround-view camera, night-vision optional. **Warranty & Service:** 2-year unlimited-mileage vehicle warranty, 8-year or 160,000 km battery warranty with 70 percent capacity guarantee, service intervals every 30,000 km. **Availability:** 10-14 week delivery build-to-order in Zuffenhausen, 12 standard colors including Frozen Berry Metallic and Gentian Blue Metallic, Porsche Exclusive program offers historic and custom paint. **Sample lease:** from 1,299 EUR/month over 48 months with 15,000 km/year and 20,000 EUR down payment, 3 years of free Ionity high-power charging included for new orders.',
