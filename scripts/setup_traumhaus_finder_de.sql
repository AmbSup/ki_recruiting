...
BEGIN
  ...
  INSERT INTO sales_offers (
    ...
    (v_program_id,
     ...
     '165 m² Einfamilienhaus mit Wintergarten + 800 m² Garten — perfekt für Familien, 20 Min nach Wien.',
     'Das Einfamilienhaus in Klosterneuburg ist ein 165 m² großes Familienhaus auf einem 800 m² Eckgrundstück (Bj. 1997, neue Heizung 2020, neues Dach 2022). **Lage:** Klosterneuburg-Weidling, 20 Auto-Min ins Wiener Zentrum, S40 in 8 Min, Schule + Kindergarten in Gehweite. **Aufteilung:** 4 Zimmer (Wohnzimmer 35 m², 3 Schlafzimmer 12-18 m²), Wohnküche, Wintergarten 12 m², 2 Bäder, separates WC, Keller (90 m²). **Highlights:** Doppelgarage mit Direktzugang ins Haus, 800 m² Süd-West-Garten mit Terrasse + Naturpool, Wintergarten als zweiter Wohnraum nutzbar, neue Glasfaser-Anbindung. **Heizung:** Wärmepumpe Luft-Wasser (Bj. 2020 — Energieklasse B), optional PV-Anlage am Dach nachrüstbar (5 kWp ~ 8.500 €). **Verfügbar ab:** 1. April 2026 (Vorbesitzer zieht ins Pflegeheim). **Kaufpreis:** 650.000 €.',
    ...
    (v_program_id,
     ...
     '380 m² Premium-Villa mit Pool, Sauna, Smart-Home auf 1.800 m² Wienerwald-Lage — Wohnen wie in Anlage.',
     'Die Villa in Pressbaum am Wienerwald ist eine 380 m² Premium-Architekten-Villa auf einem 1.800 m² Hanggrundstück mit Süd-Hang (Bj. 2018, Architekt: Studio Wien). **Lage:** Pressbaum-Ort, 25 Auto-Min ins Wiener Zentrum, S50 in 6 Min, naturnahe Hochlage mit Blick auf den Wienerwald. **Aufteilung:** 7 Zimmer auf 2 Ebenen (Wohnzimmer 65 m², 5 Schlafzimmer 14-22 m², Heimkino 18 m²), Wohnküche 35 m², 4 Bäder + Wellness-Bereich. **Premium-Highlights:** beheizter Pool 6x12 m (ganzjahres-nutzbar), Sauna + Dampfbad, KNX-Smart-Home (Licht, Klima, Jalousien, Audio per App), 360°-Sicherheitssystem mit Videoüberwachung, Eichenparkett überall, 4 m hohe Fensterfronten, Designerküche bulthaup b3, Weinkeller. **Heizung:** Erdwärmesonden-Heizung mit PV-Unterstützung (8 kWp am Dach, Energieklasse A+), KWL-Kontrollierte Wohnraumlüftung. **Stellplätze:** Doppelgarage + 2 Carport. **Verfügbar ab:** sofort. **Kaufpreis:** 1.890.000 €.',
    ...
    (v_program_id,
     'Reihenhaus Mödling',
     '145 m² modernes Reihenhaus mit Doppelgarage + Carport — perfekt für junge Familien, 15 Min nach Wien.',
     'Das Reihenhaus in Mödling ist ein 145 m² großes Familien-Reihenhaus in einer ruhigen Anliegerstraße (Bj. 2009, einwandfrei gepflegt). **Lage:** Mödling-Süd, 15 Auto-Min nach Wien (A2 oder Südstrecke), Bahn in 12 Min am Wien Hbf, Schule + Kindergarten + Park in 3 Min Gehweite. **Aufteilung:** 4 Zimmer auf 3 Ebenen (EG: Wohnzimmer + Wohnküche + WC; OG: 3 Schlafzimmer + Bad; DG: ausgebauter Hobby-/Büroraum 28 m²), Keller mit Heizraum + Lager. **Highlights:** Doppelgarage mit Direktzugang + überdachter Carport für 2. Auto, 250 m² Süd-West-Garten mit Terrasse + Sandkiste, Glasfaser-Internet, Smart-Thermostat-Heizungssystem. **Heizung:** Gasbrennwerttherme (Bj. 2009, Wartung jährlich, Energieklasse C), Solarthermie für Warmwasser am Dach (Bj. 2015). **Verfügbar ab:** 1. März 2026 (Verkäufer zieht ins Burgenland-Landhaus). **Kaufpreis:** 720.000 €.',
    ...
    (v_program_id,
     ...
     'Charmanter ehemaliger Bauernhof mit Stadl + 2.500 m² Grund — Sanierungs-Schmuckstück für Liebhaber.',
     'Das Landhaus im Burgenland (Eisenstadt-Umgebung) ist ein 220 m² ehemaliger Bauernhof aus dem 19. Jahrhundert (Bj. 1880, Teilsanierung 1995) mit Hof, Stadl und 2.500 m² Grundstück. **Lage:** kleines Dorf 15 Min südlich von Eisenstadt, 50 Auto-Min ins Wiener Zentrum, herrliche Hügellandschaft mit Weingärten ringsum. **Aufteilung:** Wohnhaus mit 6 Zimmern auf 2 Ebenen (Wohnzimmer mit offenem Kamin 40 m², 4 Schlafzimmer 14-20 m², Wohnküche 30 m², 2 Bäder), Stadl mit 120 m² Nutzfläche (Lager, Werkstatt, Garage), gepflasterter Innenhof. **Charakter:** denkmalgeschützte Fassade mit Holzbalkendecken, Naturstein-Mauerwerk, hohe Raumhöhen, charmanter Mix aus Original und 1995er-Sanierung. **Sanierungs-Potenzial:** Stadl könnte zu zusätzlichem Wohnraum / Office / Atelier umgebaut werden (Genehmigung wahrscheinlich, ca. 80.000-120.000 € Invest). **Heizung:** Holzofen + Pellets-Zentralheizung (Bj. 1995, Energieklasse E — sanierungsbedürftig). **Verfügbar ab:** sofort. **Kaufpreis:** 380.000 €.',
    ...
    (v_program_id,
     ...
     '210 m² Penthouse mit 80 m² Dach-Terrasse + Donau-Blick — Premium-Wohnen über den Dächern von Wien.',
     'Das Penthouse in 1030 Wien Landstraße ist eine 210 m² große Top-Etage in einem brandneuen Premium-Objekt (Bj. 2021, Erstbezug-Charakter, Vorbesitzer nur 6 Monate genutzt). **Lage:** Landstraße in Mitte 3. Bezirk, 8 Min U-Bahn zur Innenstadt, S-Bahn-Anbindung direkt, Donaupark in 5 Min Gehweite. **Aufteilung:** 5 Zimmer auf einer Ebene (Wohnzimmer 55 m² mit Donau-Blick, 3 Schlafzimmer 16-22 m², Arbeitszimmer 18 m²), offene Designerküche 30 m², 3 Bäder. **Premium-Highlights:** 80 m² umlaufende Dach-Terrasse mit Donau- und Stephansdom-Blick, Outdoor-Küche, Wärmepumpe für Pool-Pad (optional), bodentiefe Verglasung, Smart-Home, edler Steinboden im Wohnbereich, 3 m Raumhöhe, Concierge-Service im Haus. **Stellplätze:** 2 Tiefgaragenplätze inkludiert. **Heizung:** Fernwärme + Wärmepumpe (Energieklasse A+), KWL-Lüftung. **Verfügbar ab:** sofort. **Kaufpreis:** 2.300.000 €.',
